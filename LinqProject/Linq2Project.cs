...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //AnyTest(products); //Bir listenin icerisinde bir eleman var mi yok mu onu kontrol eder. Sonuc bool(true-false) döner

            //FindTest(products); //Sorgu sonucuna göre o nesnenin tüm bilgilersini getirir.Sorgu sonucu yoksa null gelir.

            //FindAllTest(products);  //Sorgu sonucuna göre uyan nesnelerin tüm bilgilersini liste olarak getirir
