...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           /* Console.WriteLine("---------------Algoritmik ile filtreleme--------------------");
            ...
            /*Console.WriteLine("---------------Linq ile filtreleme-----------------");

            var result = products.Where(p => p.UnitPrice > 5000 && p.UnitInStock > 3);// result array tabanli, kod kalabalığını engeller.
       ...
       //bunları metota dökelim;
        ...
        //Linq olmasaydı yazmak zorunda kalacağım kod
        ...
        //Linq olduğunda ürünü filtreleme işlemi çok daha basite iner
        static List<Product> GetProductsLinq(List<Product> products)
        {
            return products.Where(p => p.UnitPrice > 5000 && p.UnitInStock > 3).ToList();
            //buradaki Where fonksiyonu foreach kullanmama gerek bıraktırmıyor.
        }
